...
export function BudgetManageCategoriesModal({
  ...
  const getCategoryCheckState = (
    ...
    const selectedCount = categoryExpenses.filter((e) =>
  ...
  const categoryListContent = (
    <>
      ...
      <div className="space-y-2">
        {categories
          .filter(
            (category) => (expensesByCategory[category.name] || []).length > 0
          )
          .map((category) => {
            ...
            const frequencies = hasExpenses
              ? getCategoryFrequencies(categoryExpenses)
              : ""
              ...
              <div key={category.id}>
                ...
                <div
                    ...
                    <div
                      ...
                      {checkState === "indeterminate" ? (
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            handleToggleCategory(categoryExpenses)
                          }
                  ...
                  <div
                    ...
                    onClick={() =>
                      hasExpenses && handleToggleCategory(categoryExpenses)
                    }>
                    <div
                      className={cn(
                        "font-medium",
                  ...
                  {hasExpenses && (
                    <div className="text-right">
                      <div
                        ...
                        $
                        {categoryTotal.toLocaleString("en-SG", {
                        ...
                        <div
                          ...
                          <div className="flex-1">
                            ...
                            <span
                              ...
                              &bull; {formatFrequency(expense.frequency)}
                            </span>
                          </div>
                        </div>
                      )
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent>
        ...
        <DrawerBody>{categoryListContent}</DrawerBody>

        {/* Footer with buttons */}
        <DrawerFooter className="pb-8">{footerButtons}</DrawerFooter>
      </DrawerContent>
    </Drawer>
  )
}
