...
import { getUserExpenses } from "@/actions/user"
...
export function TotalExpensesCard({
  ...
  const monthChange = useMemo(() => {
    ...
    const percentChange =
      previousMonthExpenses > 0 ? (change / previousMonthExpenses) * 100 : 0
  ...
  const displayAmount =
    expenses.length > 0 ? currentMonthExpenses : totalExpenses
