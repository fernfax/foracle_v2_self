...
export async function updateDailyExpense(
  ...
  if (data.subcategoryName !== undefined)
    patch.subcategoryName = data.subcategoryName
  if (data.amount !== undefined) patch.amount = data.amount.toString()
  if (data.note !== undefined) patch.note = data.note
  if (data.date !== undefined) patch.date = data.date
  if (data.originalCurrency !== undefined)
    patch.originalCurrency = data.originalCurrency
  if (data.originalAmount !== undefined)
    patch.originalAmount =
      data.originalAmount === null ? null : data.originalAmount.toString()
  if (data.exchangeRate !== undefined)
    patch.exchangeRate =
      data.exchangeRate === null ? null : data.exchangeRate.toString()
