...
export async function updateIncome(
  ...
  if (data.incomeCategory !== undefined)
    updateData.incomeCategory = toBetaIncomeCategory(data.incomeCategory)
  if (data.amount !== undefined) updateData.amount = data.amount.toString()
  if (data.subjectToCpf !== undefined)
    updateData.subjectToCpf = data.subjectToCpf
  if (data.accountForBonus !== undefined)
    updateData.accountForBonus = data.accountForBonus
  ...
  if (data.pastIncomeHistory !== undefined)
    updateData.pastIncomeHistory = data.pastIncomeHistory
  if (data.futureMilestones !== undefined)
    updateData.futureMilestones = data.futureMilestones
  if (data.accountForFutureChange !== undefined)
    updateData.accountForFutureChange = data.accountForFutureChange
  if (data.description !== undefined) updateData.description = data.description
  if (data.isActive !== undefined) updateData.isActive = data.isActive
  if (data.familyMemberId !== undefined)
    updateData.familyMemberId = data.familyMemberId || null
  if (data.cpfOrdinaryAccount !== undefined)
    updateData.cpfOrdinaryAccount = data.cpfOrdinaryAccount.toString()
  if (data.cpfSpecialAccount !== undefined)
    updateData.cpfSpecialAccount = data.cpfSpecialAccount.toString()
  if (data.cpfMedisaveAccount !== undefined)
    updateData.cpfMedisaveAccount = data.cpfMedisaveAccount.toString()
  ...
  const finalAmount =
    data.amount !== undefined ? data.amount : parseFloat(existing.amount)
...
export async function deleteIncome(id: string) {
  ...
  if (existing.familyMemberId && existing.familyMember) {
    throw new Error(
      `This income is linked to ${existing.familyMember.name} and cannot be deleted independently. Please delete the family member to remove their associated incomesBeta.`
    )
  }
