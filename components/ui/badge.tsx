...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border-0 px-3 py-1.5 font-display text-[10px] font-semibold leading-none uppercase tracking-[0.14em] transition-colors shadow-[0_1px_4px_rgba(28,43,42,0.04)] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "bg-[rgba(184,98,42,0.14)] text-[#7A3A0A] dark:bg-[rgba(212,132,90,0.18)] dark:text-[#D4845A]",
        success:
          "bg-[rgba(0,196,170,0.14)] text-[#007A68] dark:bg-[rgba(0,196,170,0.18)] dark:text-[#33D4BC]",
        warning:
          "bg-[rgba(212,168,67,0.18)] text-[#7A5A00] dark:bg-[rgba(212,168,67,0.20)] dark:text-[#D4A843]",
        danger:
          "bg-[rgba(224,85,85,0.14)] text-[#8B0000] dark:bg-[rgba(224,112,112,0.18)] dark:text-[#E07070]",
        destructive:
          "bg-[rgba(224,85,85,0.14)] text-[#8B0000] dark:bg-[rgba(224,112,112,0.18)] dark:text-[#E07070]",
        neutral:
