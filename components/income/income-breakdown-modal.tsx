  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[80vh] max-w-4xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            Income Breakdown - {formatMonthDisplay(effectiveMonth)}
          </DialogTitle>
          <DialogDescription>
            Detailed breakdown of your income for{" "}
            {formatMonthDisplay(effectiveMonth)}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-muted/30 grid grid-cols-2 gap-4 rounded-lg p-4">
            <div>
              ...
              <p className="text-2xl font-semibold">
                ${breakdownDetails.grossAnnualIncome.toLocaleString()}
              </p>
            </div>
            <div>
              <p className="text-muted-foreground text-sm">
                Net Annual Income (after CPF)
              </p>
              <p className="text-2xl font-semibold">
                ${breakdownDetails.netAnnualIncome.toLocaleString()}
              </p>
            </div>
            <div>
              <p className="text-muted-foreground text-sm">
              ...
              <p className="text-lg font-semibold">
                {breakdownDetails.activeIncomeCount}
              </p>
            </div>
          </div>
          ...
          {breakdownDetails.familyMembersArray.length > 0 && (
            <div>
              <h3 className="mb-3 text-lg font-semibold">By Family Member</h3>
                  ...
                  <div
                    ...
                    <div className="mb-2 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs">
                          {cat.count} income source{cat.count !== 1 ? "s" : ""}
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="text-lg font-bold">
                          ${cat.gross.toLocaleString()}
                        </p>
                        <p className="text-muted-foreground text-xs">
