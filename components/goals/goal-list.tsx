...
function iconForGoal(goalName: string): LucideIcon {
  ...
  if (n.includes("trip") || n.includes("travel") || n.includes("holiday")) return Plane;
  ...
  return (
    <>
              ...
              >
                ...
                {!isAchievedView && (
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 rounded-lg border border-border/60 py-2 text-xs font-medium text-muted-foreground transition-colors hover:bg-[rgba(0,196,170,0.10)] hover:text-[#007A68] dark:hover:text-[#33D4BC]"
                  >
      ...
      <ConfirmDialog
        ...
        description={
          <>
            &ldquo;{goalToDelete?.goalName}&rdquo; will be removed. This can&rsquo;t be undone.
