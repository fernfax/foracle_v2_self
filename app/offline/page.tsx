    ...
    <main className="flex min-h-svh flex-col items-center justify-center gap-6 bg-background px-6 text-center">
      ...
      <div className="max-w-sm space-y-2">
        ...
        <p className="text-[15px] leading-relaxed text-muted-foreground">
          Foracle can&apos;t reach the network right now. Your budget needs a connection to stay
          accurate, so it&apos;s paused until you&apos;re back online.
        </p>
      </div>
      <Link
        href="/budget"
