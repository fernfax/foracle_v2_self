...
export async function listPolicies(
  ...
  if (filters.isActive !== undefined)
    conditions.push(eq(policies.isActive, filters.isActive))
  if (filters.policyType !== undefined)
    conditions.push(eq(policies.policyType, filters.policyType))
...
export async function updatePolicy(
  ...
  if (patch.linkedExpenseId !== undefined)
    update.linkedExpenseId = patch.linkedExpenseId ?? null
  ...
  if (patch.policyNumber !== undefined)
    update.policyNumber = patch.policyNumber ?? null
  ...
  if (patch.maturityDate !== undefined)
    update.maturityDate = patch.maturityDate ?? null
  if (patch.coverageUntilAge !== undefined)
    update.coverageUntilAge = patch.coverageUntilAge ?? null
  if (patch.premiumAmount !== undefined)
    update.premiumAmount = patch.premiumAmount
  if (patch.premiumAmountCPF !== undefined)
    update.premiumAmountCPF = patch.premiumAmountCPF ?? null
  if (patch.premiumFrequency !== undefined)
    update.premiumFrequency = patch.premiumFrequency
  ...
  if (patch.coverageOptions !== undefined)
    update.coverageOptions = patch.coverageOptions ?? null
  if (patch.cashValue !== undefined) update.cashValue = patch.cashValue ?? null
  if (patch.cashValueDate !== undefined)
    update.cashValueDate = patch.cashValueDate ?? null
