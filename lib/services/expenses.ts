...
export async function updateExpense(
  ...
  if (patch.expenseCategory !== undefined) update.expenseCategory = patch.expenseCategory;
  ...
  if (patch.trackedInBudget !== undefined) update.trackedInBudget = patch.trackedInBudget;
