...
export async function updateGoal(
  ...
  if (patch.addToExpenditures !== undefined || patch.monthlyContribution !== undefined) {
    if (
  ...
  if (patch.currentAmountSaved !== undefined) update.currentAmountSaved = patch.currentAmountSaved;
