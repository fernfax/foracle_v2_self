...
import { completeOnboarding, createOnboardingExpenses } from "@/lib/services/onboarding";
...
const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    expenses: { Housing: "2500", Food: "1200", Transportation: "600", Entertainment: "400" },
  },
  {
    key: "04_young_family",
    ...
    holdings: ["30000"],
    expenses: { Housing: "3000", Food: "1500", Children: "1200", Transportation: "800", Healthcare: "300" },
  },
  {
    key: "05_sandwich_gen",
    ...
    holdings: ["60000"],
    expenses: { Housing: "2800", Food: "1400", Healthcare: "900", Allowances: "1000" },
  },
  {
    key: "06_pre_retiree",
  ...
  },
  {
    ...
    expenses: { Housing: "6000", Food: "2500", Transportation: "1500", Entertainment: "2000" },
  },
  {
    key: "08_freelancer",
  ...
  },
  {
    ...
    holdings: ["1000"],
    expenses: { Housing: "1800", Food: "900", Shopping: "800", Entertainment: "700", Transportation: "400" },
  },
  {
    key: "10_power_user",
    ...
    expenses: {
      Housing: "3500", Food: "1800", Transportation: "1000", Utilities: "400",
      Healthcare: "500", Children: "900", Entertainment: "600", Shopping: "500",
    },
  },
];
...
async function summaryFor(ctx: AuthContext) {
  const [incomes, expenseRows, holdingRows, members] = await Promise.all([
    ...
    db.query.currentHoldings.findMany({ where: eq(currentHoldings.familyId, ctx.familyId) }),
